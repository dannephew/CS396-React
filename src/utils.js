...
export function getHeaders () {
    ...
    const csrf_access_token = getCookie('csrf_access_token'); //set by flask
    let headers;

    //internal request: happens of react and flask on running on same server
    ...
    //external request: when react and flask on diff servers
